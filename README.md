...
### Prerequisites  
- You’ll need Python installed on your machine (version 3.x is recommended).  
- Optionally, a code editor/IDE such as Visual Studio Code.
...
3. Select the `Python‑Practicals` folder you cloned.  
4. (Optional) Open an integrated terminal from **Terminal → New Terminal** to run Python files via:  
```bash
python filename.py
```
...
- Each Python file is self‑contained and can be executed directly.  
- Feel free to modify scripts or extend them for learning.
